...
with sync_playwright() as p:
    ...
    page.goto("https://www.amazon.in/ASUS-Upgradeable-Keyboard-Graphite-FA506NCG-HN199W/dp/B0FM3C4L2F/ref=sr_1_6?sr=8-6")
    ...
    Rating = page.locator('span.a-icon-alt:has-text("out of 5 stars")').nth(1).inner_text()
    # print(Rating)
    ...
    # Product Details 
    product_details = page.locator("table.a-normal.a-spacing-micro[role='list'] tbody").inner_html()
